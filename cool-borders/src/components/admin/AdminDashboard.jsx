        ...
        <>
            ...
            <div className="flex flex-col justify-between  w-full h-full mt-2 p-3 bg-black rounded">
                ...
                <div className='flex justify-between'>
                    ...
                    <button className='bg-indigo-500 p-2 w-20 rounded text-xs mt-2'>Confirm</button>
                    <button className='bg-indigo-500 p-2 w-20 rounded text-xs mt-2'>Edit</button>
                    <button className='bg-indigo-500 p-2 w-20 rounded text-xs mt-2'>Delete</button>
                </div>
