...
export const buttonMD = "md:m-10 md:text-lg md:w-40"

// Headings
export const heading2 = "text-4xl mb-2 mt-10 text-title font-bold text-gray-100"

// Navigation
export const navLink = "hover:text-gray-600"
